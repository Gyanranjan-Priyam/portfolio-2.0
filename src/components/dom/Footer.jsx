    ...
    >
      ...
      >
        <AppearTitle isFooter>
          <h6 className={clsx(styles.title, 'h6')}>Navigation</h6>
      ...
      >
        <AppearTitle isFooter>
          <h6 className={clsx(styles.title, 'h6')}>Let's Connect</h6>
        ...
        <AppearTitle isFooter>
          ...
          <div>
            <div className={styles.link}>
              ...
              >
                <h4 className={clsx(styles.email, 'h4')}>info@priyam.tech</h4>
              </Link>
      ...
      <div className={styles.middleContainer} style={{ gridColumn: '1 / 9' }}>
        <AppearTitle isFooter>
          <div className="p-x">Based in Bhubaneswar, India</div>
