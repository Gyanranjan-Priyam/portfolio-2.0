...
function Page({ id }) {
  ...
  const seo = useMemo(
    () => ({
      title: `Priyam - ${currentProject.title} Project`,
      description: `Check out my work on the ${currentProject.title} project, collaborating with ${currentProject.company}, where I enhanced full stack development with responsive design and optimized user interactions.`,
      keywords: [
        `${currentProject.title} project`,
        `${currentProject.title} development`,
        `${currentProject.company} collaboration`,
        `Priyam ${currentProject.title}`,
