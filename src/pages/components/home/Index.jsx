    ...
    <section ref={rootRef} className={clsx(styles.root)}>
      <div className={clsx(styles.topContainer, 'layout-grid-inner')}>
        <div className={styles.leftContainer}>
          <h2 className={clsx('h2', 'name-text')}>Gyanranjan</h2>
          <h2 className={clsx('h2', 'bold', 'name-text')}>Priyam</h2>
        </div>
        {!isMobile && (
          <h6 className={clsx('h6', styles.rightContainer)}>
            I’m a full-stack engineer focused on building immersive digital
            environments that elevate your virtual presence. Let’s redefine how
            people interact online together.{' '}
          </h6>
        )}
      </div>
